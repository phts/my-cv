...
\section*{Experience}
    ...
    \begin{itemize}
        ...
        \item \position{Front-End Developer}, \difftoday{2018}{04}
            ...
            Developing marketing landing pages.

            Developing landing page constructor - a graphical application to be used by non-tech guys to create and publish landing pages.

            Participating in a constant improving of development process and getting rid of legacy stuff.

            Developed and supporting an interactive tool which allows to create a working landing page template.

            \begin{itemize}
                \item \itemlabel{Company} Grand Parade, Kraków Area, Poland
                \item \itemlabel{Tools \& technologies used} HTML5/CSS3, JavaScript, SASS, React, React-static, EJS, Webpack, rollup, mocha, Git, jira, Jenkins, Node.js
            \end{itemize}
