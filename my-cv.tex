...
\section*{Experience}
    ...
    \begin{itemize}
        ...
        \item \position{Front-End Developer}, \difftoday{2018}{04}
            ...
            This is Node.js application uses EJS template engine to simplify the process of gathering parts of
            a page together and to automate a routine and manual work.

            Later was involved to planning and developing of several new projects from scratch.
            ...
            changing standup driver every day across the team, pushing code before going home, introducing and following
            ...
            experimenting with new technologies and conducting workshops and knowledge sharings.
            ...
            \begin{itemize}
                ...
                \item \itemlabel{Tools \& technologies used} HTML5/CSS3, JavaScript, TypeScript, SASS, React, Gatsby, EJS, Node.js, AWS,
                    Express, Webpack, rollup, mocha, jest, Git, Jira, Jenkins, npm, server-side rendering, Docker
            \end{itemize}
